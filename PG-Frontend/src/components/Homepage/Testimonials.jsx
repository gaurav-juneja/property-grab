          ...
          <div className="row pt-5 justify-content-between">
            ...
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                  A big shout to Property Grab for making the Home Grab so easy and
                  comfortable.i recommend Property Grab to everyone who is looking
                  to find Homes.
                </p>
              </div>
            </div>
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                  Thanks to the Property Grab who gave me so many opions to choose
            ...
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                  Just Great Property Grab ! I was able to find very spacious and
